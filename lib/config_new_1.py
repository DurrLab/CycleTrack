...
class config(object):
    ...
    def __init__(self):
        ...
        self.dataset='cell_tracking1'
        self.test_dataset='cell_tracking1'
        self.exp_id='cell_tracking1'
        self.test=False
        ...
        self.load_model='/cis/home/lhuang/my_documents/Cytometry/CenterTrack/exp/tracking/cell_tracking1/logs_2020-09-27-15-13/model_300.pth'
